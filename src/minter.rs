...
mod royal_nft {
    ...
    impl RoyalNFTs {
        pub fn start_minting_nft(
            ...
            let mut depositer_resource_requirements: Vec<ResourceAddress> = vec![];
            ...
            if royalty_config_input.royalties_enabled {
                if royalty_config_input.honoured {
                    ...
                    depositer_resource_requirements = vec![nft_creator_admin.resource_address()];
                } else {
                    ...
                    depositer_resource_requirements = vec![
                        royalty_config_input.depositer_admin,
                        internal_creator_admin.resource_address(),
                        nft_creator_admin.resource_address(),
                    ];
            ...
            .metadata(metadata! {
                ...
                init {
                    ...
                    "deposit_rules" => depositer_resource_requirements, updatable;
                    //**** REQUIRED FOR ROYALTY COMPATABILITY */
